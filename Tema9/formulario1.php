...
no se indica) el envio se realizará usando method='GET' También es opcional -a los
efectos de PHP- incluir name. Ese valor es útil cuando se incluyen scripts del lado del
cliente del tipo JavaScript -->
<form name='mi_formulario' action='fichero1.php' method='post'>
<!-- Pueden incluirse textos dentro del formulario --> 
Escribe tu nombre:
<!-- Uno de los tipos de campos posibles es el tipo texto su sintaxis 
...
ventana al número de caracteres que se indiquen --> 
<input type='text' name='nombre' value='' size=15><br> 
Escribe tu clave:
<!-- <input type='password'> solo se diferencia del anterior en que en el momento de
rellenarlo se sustituyen los carecteres visualizados (no el contenido) por asteriscos --> 
<input type='password' name='clave' value=''><br> 
Elige tu color de coche favorito:<br> 
<!-- Los <input type='radio'> permite optar entre varios valores
...
Elige los extras:<br>
<!-- Cada uno de los <input type='checkbox'> requiere un nombre distinto (name) y un
valor (value) permite optar entre varios Esos valor (loquesea) serám transferido a
...
<!-- La etiqueta <input type='select'> requiere un nombre y requiere también una
...
defecto al cargarse el formulario//--> 
<select name="precio">
        <Option>Menos de 6.000 euros</option>
        <Option>6.001 - 8.000 euros</option>
        <Option selected>8.001 - 10.000 euros</option> <!-- Selected sirve para marcarlo como predeterminado -->
...
en ese espacio en el momento de cargar rl formulario --> 
...
visible en el documento requiere un name y un value //--> 
<input type="hidden" name='oculto' value='Esto iría oculto'><br> 
<!-- El <input type='submit'> es el encargado de ejecutar la action incluida en la etiqueta de apertura del formulario que
en este caso sería la llamada a la página que se indica en la action El texto que
incluyamos en value='enviar...' será el que se visualice en el propio botón de envio --> 
<input type="submit" value="enviar"> <!-- El <input type='reset'> 
Permite borrar todos los contenidos del formulario y reestablecer los valores por defecto de
cada campo --> 
<input type="reset" value="borrar"> 
<!-- La etiqueta </form> es la etiqueta de cierre del formulario //--> </FORM> </BODY> </HTML>