...
print("La suma de $a + $b es: " . $a . "+" . $b . "=" . ($a+$b)."<br>"); //Con print hay que poner la operacion entre parentesis sino da error.
print "La suma de $a + $b es: " . $a . "+" . $b . "=" . ($a+$b) ."<BR>";
print ("La suma de $a + $b es: " . $a . "+" . $b . "=" . ($a+$b) ."<BR>");
echo "La suma de $a + $b es: " . $a . "+" . $b . "=" . ($a+$b) ."<BR>";
echo "La suma de $a + $b es: " , $a , "+" , $b . "=" , ($a+$b) ."<BR>";
echo "La suma de $a + $b es: " , $a , "+" , $b , "=" , $a+$b ,"<BR>"; //Esto con print no funcionaria
...
# experimentemos con los paréntesis en un supuesto de operacionescombinada
