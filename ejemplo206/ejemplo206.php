...
$resultado=mysqli_query($conexion,"SELECT companeros.DNI,companeros.Nombre,companeros.Apellido1, companeros.Apellido2 ,demodat1.Puntos, demodat2.Puntos, demodat3.Puntos FROM companeros, demodat1, demodat2, demodat3 WHERE (companeros.DNI=demodat1.DNI AND companeros.DNI=demodat2.DNI AND companeros.DNI=demodat3.DNI)  ");
